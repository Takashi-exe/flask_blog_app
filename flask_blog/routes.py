...
from flask_blog.forms import (registeration_form, login_form, update_account_form,
                                post_form, request_reset_form, reset_password_form)
...
def register():
    ...
    if form.validate_on_submit():
        ...
        db.session.add(user)
        db.session.commit()
        flash(f"Account created successfully! You may now login!", "success")
...
def update_post(post_id):
    ...
    return render_template('create_post.html', title = 'Update Post',
                            post = post, form = form, legend = 'Update Post')
